...
describe('CPU usage model provider', () => {
    ...
    /*
     * Queries only total series for the CPU usage endpoint
     */
    it('queries 10 xy points to the CPU usage endpoint from trace start to trace end', async (done) => {
        testXYPoints(10, 20);
        done();
    });
     ...
     * Queries only total series for the CPU usage endpoint
     */
    it('queries 100 xy points to the CPU usage endpoint from trace start to trace end', async (done) => {
        testXYPoints(100, 20);
        done();
    });
     ...
     * Queries only total series for the CPU usage endpoint
     */
    it('queries 1000 xy points to the CPU usage endpoint from trace start to trace end', async (done) => {
        testXYPoints(1000, 20);
        done();
    });

    it('queries the xy entries to the CPU usage endpoint from trace start to trace end', async (done) => {
