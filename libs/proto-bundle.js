...
goog.exportSymbol('proto.timegraph.ControlFlowEvents', null, global);
goog.exportSymbol('proto.timegraph.ControlFlowRowModel', null, global);
goog.exportSymbol('proto.timegraph.TimeGraphState', null, global);
 ...
 * @constructor
 */
proto.timegraph.TimeGraphState = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.timegraph.TimeGraphState, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.timegraph.TimeGraphState.displayName = 'proto.timegraph.TimeGraphState';
}
 ...
 * @return {!Object}
 */
proto.timegraph.TimeGraphState.prototype.toObject = function(opt_includeInstance) {
  return proto.timegraph.TimeGraphState.toObject(opt_includeInstance, this);
};
 ...
 * @param {!proto.timegraph.TimeGraphState} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timegraph.TimeGraphState.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.timegraph.TimeGraphState}
 */
proto.timegraph.TimeGraphState.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.timegraph.TimeGraphState;
  return proto.timegraph.TimeGraphState.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.timegraph.TimeGraphState} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.timegraph.TimeGraphState}
 */
proto.timegraph.TimeGraphState.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.timegraph.TimeGraphState.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.timegraph.TimeGraphState.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.timegraph.TimeGraphState} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timegraph.TimeGraphState.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.timegraph.TimeGraphState.prototype.getStarttime = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.timegraph.TimeGraphState.prototype.setStarttime = function(value) {
 ...
 * @return {number}
 */
proto.timegraph.TimeGraphState.prototype.getDuration = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.timegraph.TimeGraphState.prototype.setDuration = function(value) {
 ...
 * @return {number}
 */
proto.timegraph.TimeGraphState.prototype.getValue = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.timegraph.TimeGraphState.prototype.setValue = function(value) {
 ...
 * @return {string}
 */
proto.timegraph.TimeGraphState.prototype.getLabel = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.timegraph.TimeGraphState.prototype.setLabel = function(value) {
 ...
 * @constructor
 */
proto.timegraph.ControlFlowRowModel = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.timegraph.ControlFlowRowModel.repeatedFields_, null);
};
goog.inherits(proto.timegraph.ControlFlowRowModel, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.timegraph.ControlFlowRowModel.displayName = 'proto.timegraph.ControlFlowRowModel';
}
/**
 ...
 * @const
 */
proto.timegraph.ControlFlowRowModel.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.timegraph.ControlFlowRowModel.prototype.toObject = function(opt_includeInstance) {
  return proto.timegraph.ControlFlowRowModel.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.timegraph.ControlFlowRowModel} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timegraph.ControlFlowRowModel.toObject = function(includeInstance, msg) {
  var f, obj = {
    entryid: jspb.Message.getFieldWithDefault(msg, 1, 0),
    statesList: jspb.Message.toObjectList(msg.getStatesList(),
    proto.timegraph.TimeGraphState.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.timegraph.ControlFlowRowModel}
 */
proto.timegraph.ControlFlowRowModel.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.timegraph.ControlFlowRowModel;
  return proto.timegraph.ControlFlowRowModel.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.timegraph.ControlFlowRowModel} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.timegraph.ControlFlowRowModel}
 */
proto.timegraph.ControlFlowRowModel.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.timegraph.TimeGraphState;
      reader.readMessage(value,proto.timegraph.TimeGraphState.deserializeBinaryFromReader);
      msg.addStates(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.timegraph.ControlFlowRowModel.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.timegraph.ControlFlowRowModel.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.timegraph.ControlFlowRowModel} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timegraph.ControlFlowRowModel.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.timegraph.TimeGraphState.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {number}
 */
proto.timegraph.ControlFlowRowModel.prototype.getEntryid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.timegraph.ControlFlowRowModel.prototype.setEntryid = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * repeated TimeGraphState states = 2;
 * @return {!Array.<!proto.timegraph.TimeGraphState>}
 */
proto.timegraph.ControlFlowRowModel.prototype.getStatesList = function() {
  return /** @type{!Array.<!proto.timegraph.TimeGraphState>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.timegraph.TimeGraphState, 2));
};


/** @param {!Array.<!proto.timegraph.TimeGraphState>} value */
proto.timegraph.ControlFlowRowModel.prototype.setStatesList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.timegraph.TimeGraphState=} opt_value
 * @param {number=} opt_index
 * @return {!proto.timegraph.TimeGraphState}
 */
proto.timegraph.ControlFlowRowModel.prototype.addStates = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.timegraph.TimeGraphState, opt_index);
};


proto.timegraph.ControlFlowRowModel.prototype.clearStatesList = function() {
  this.setStatesList([]);
};
 ...
 * @constructor
 */
proto.timegraph.ControlFlowEvents = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.timegraph.ControlFlowEvents.repeatedFields_, null);
};
goog.inherits(proto.timegraph.ControlFlowEvents, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.timegraph.ControlFlowEvents.displayName = 'proto.timegraph.ControlFlowEvents';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.timegraph.ControlFlowEvents.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.timegraph.ControlFlowEvents.prototype.toObject = function(opt_includeInstance) {
  return proto.timegraph.ControlFlowEvents.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.timegraph.ControlFlowEvents} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timegraph.ControlFlowEvents.toObject = function(includeInstance, msg) {
  var f, obj = {
    modelList: jspb.Message.toObjectList(msg.getModelList(),
    proto.timegraph.ControlFlowRowModel.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.timegraph.ControlFlowEvents}
 */
proto.timegraph.ControlFlowEvents.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.timegraph.ControlFlowEvents;
  return proto.timegraph.ControlFlowEvents.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.timegraph.ControlFlowEvents} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.timegraph.ControlFlowEvents}
 */
proto.timegraph.ControlFlowEvents.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.timegraph.ControlFlowRowModel;
      reader.readMessage(value,proto.timegraph.ControlFlowRowModel.deserializeBinaryFromReader);
      msg.addModel(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.timegraph.ControlFlowEvents.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.timegraph.ControlFlowEvents.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.timegraph.ControlFlowEvents} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.timegraph.ControlFlowEvents.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.timegraph.ControlFlowRowModel.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated ControlFlowRowModel model = 1;
 * @return {!Array.<!proto.timegraph.ControlFlowRowModel>}
 */
proto.timegraph.ControlFlowEvents.prototype.getModelList = function() {
  return /** @type{!Array.<!proto.timegraph.ControlFlowRowModel>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.timegraph.ControlFlowRowModel, 1));
};


/** @param {!Array.<!proto.timegraph.ControlFlowRowModel>} value */
proto.timegraph.ControlFlowEvents.prototype.setModelList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.timegraph.ControlFlowRowModel=} opt_value
 * @param {number=} opt_index
 * @return {!proto.timegraph.ControlFlowRowModel}
 */
proto.timegraph.ControlFlowEvents.prototype.addModel = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.timegraph.ControlFlowRowModel, opt_index);
};


proto.timegraph.ControlFlowEvents.prototype.clearModelList = function() {
  this.setModelList([]);
};


goog.object.extend(exports, proto.timegraph);

},{"./google-protobuf.js":1}]},{},[2]);
